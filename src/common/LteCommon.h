...
#define LTE_QCI_CLASSES 9
    ...
    // 5QI traffic descriptor
    typedef unsigned short FiveQI;

    // MAC Control Information
    struct MacPduMetaData
    {
        MacCid cid;
        FiveQI fiveQi;
        simtime_t arrivalTime;
    };
    // List of MAC Control Information
    typedef std::vector<MacPduMetaData> MacPduMetaDataList;
